...
# colors
colors_2 <- c("#b3cc33", "#d1f0f7", "#8ddbec", "#228b22", "#afe3c8", "#7ecfa4", "#64b376", "#e1cdb6", "#b6a896", "#b69872", "#b68549", "#9c6f38", "#e5c6a0", "#e5a352", "#0000ff", "#3a3aff", "red") # "#b3cc33" "#228b22", "#7ecfa4", "blue"
...
CerrFor_evolve <- NULL
CerrFor_evolve <- lucC_pred_evolve(raster_obj = rb_sits2, raster_class1 = "Forest",
...
#                         label = label2, custom_palette = TRUE,
#                         RGB_color = colors_2, relabel = FALSE, plot_ncol = 5, shape_point = ".")
...
vsec.mtx <- lucC_pred_holds(raster_obj = rb_sits2, raster_class = "Secondary_vegetation", #### <- font secondary with V ou v
                            time_interval = c("2001-09-01","2016-09-01"),
                            relation_interval = "contains", label = label2, timeline = timeline)
#head(vsec.mtx)
...
lucC_save_GeoTIFF(raster_obj = rb_sits2,
                  data_mtx = result,
                  path_raster_folder = "~/Desktop/Ita/", as_RasterBrick = FALSE ) # FALSE before
