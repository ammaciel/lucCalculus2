...
utils::globalVariables(c("points_input_map.list", "map_input_df", "points_events_map.list",".", "value.x", "value.y", "Classes", "Area_km2", "Cumulative_Sum", "Relative_Frequency", "check", "variable", "value", "x", "y", "Var1", "Var2", "Freq"))
